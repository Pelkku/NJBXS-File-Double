...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Njbxs/NJBXS-File-Double)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/Njbxs/NJBXS-File-Double
cd NJBXS-File-Double
...
[NJBXS FILE](https://github.com/Njbxs/NJBXS-File-Double) is Free Software: You can use, study share and improve it at your
